...
## Routes / screens used
- `AutoLifeLogger-main/store-assets/screenshot-dashboard.png`
- `AutoLifeLogger-main/store-assets/screenshot-strict.png`
...
- `videos/04-linkedin-demo.mp4` (10.8 MB)
- `videos/05-x-demo.mp4` (7.8 MB)
- `videos/06-facebook-demo.mp4` (10.7 MB)
- `videos/07-github-readme-demo.mp4` (5.3 MB)
- `videos/08-portfolio-hero.mp4` (10.7 MB)
...
**Screens/routes used:** Dashboard, Strict mode.
