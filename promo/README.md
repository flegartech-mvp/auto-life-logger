# AutoLifeLogger — Promo Pack

**Tagline:** See where your browsing time really goes.

Private daily analytics that turn open tabs into focus — automatically.
...
**Instagram**
> AutoLifeLogger ⏱️ — find out where your browsing time really goes. Private daily analytics that auto-sort productive vs distracting and give you a focus score. All on your device.

**LinkedIn**
> AutoLifeLogger is a privacy-first Chrome extension that turns your open tabs into a daily focus score — auto-classifying productive vs distracting time and flagging distraction loops. Nothing leaves the device.

**X / Twitter**
> AutoLifeLogger — see where your browsing time really goes. Private daily focus analytics, on-device.

**Facebook**
> AutoLifeLogger gives you a private daily focus score from your browsing — no data ever leaves your device.

**GitHub (repo description / social preview alt)**
> AutoLifeLogger — MV3 extension for private browsing analytics & a daily focus score.

## Source screenshots

- `AutoLifeLogger-main/promo/source-screenshots/01-shot-screenshot-dashboard.png` (from `AutoLifeLogger-main/store-assets/screenshot-dashboard.png`)
- `AutoLifeLogger-main/promo/source-screenshots/02-shot-screenshot-strict.png` (from `AutoLifeLogger-main/store-assets/screenshot-strict.png`)
...
**Structure:** title card → main UI reveal → 3 feature callouts → second screen → CTA card (“Built by FlegarTech · Demo-ready product · github.com/flegartech/AutoLifeLogger”).
**Audio:** none (silent by default). Add royalty-free music in an editor if desired.

**Suggested video caption (Reels / TikTok / Shorts):**
> Watch AutoLifeLogger turn your tabs into a daily focus score ⏱️ — private, on-device analytics.

To rebuild: `node build-videos.mjs AutoLifeLogger-main` (or `promo/scripts/build-video.sh`).
